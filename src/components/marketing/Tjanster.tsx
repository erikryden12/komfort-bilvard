        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          {tjanster.slice(0, 3).map((s, i) => (
            <FadeIn key={s.num} delay={i * 0.07}>
              <Link href={`/tjanster/${s.slug}`} className="group block h-full border border-white/15 hover:border-gold/50 bg-surface-2 hover:bg-surface-1 transition-all duration-300 p-8">
